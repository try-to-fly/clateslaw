import { useData, type MonthlyData } from '../hooks/useData';
...
export default function MonthlyPage() {
  const data = useData<MonthlyData>();
  ...
  return (
    <div className="theme-bg p-2 space-y-2 screenshot-container">
        ...
        <div className="px-2.5 py-2">
          ...
          {comparison && (
            <div className="flex items-center justify-center gap-4 text-xs mt-1">
              ...
              <span className="theme-text-muted">vs 上月</span>
            </div>
          )}
        </div>
      </div>
      ...
      <div className={cardClass}>
        <div className="px-2.5 py-1.5">
          <div className="flex items-center justify-between text-xs">
            <span className="theme-text-muted">本月充电总费用</span>
